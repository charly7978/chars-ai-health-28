...
const VitalSign: React.FC<VitalSignProps> = ({ label, value, unit, highlighted = false }) => {
  ...
  return (
    <div className={`relative overflow-hidden group bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-md rounded-lg p-3 py-4 transition-all duration-300 hover:from-gray-800/60 hover:to-gray-900/60 ${
      ...
      <div className="flex items-baseline gap-1 justify-center min-h-[32px]">
        <span 
