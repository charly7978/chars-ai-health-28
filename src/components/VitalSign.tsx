...
const VitalSign: React.FC<VitalSignProps> = ({ label, value, unit, highlighted = false }) => {
  ...
  return (
    <div className={`relative overflow-hidden group bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-md rounded-lg p-3 transition-all duration-300 hover:from-gray-800/60 hover:to-gray-900/60 ${
      ...
      <h3 className={`text-white text-xs text-center mb-1 truncate ${highlighted ? 'text-cyan-400/90' : ''}`}>{label}</h3>
